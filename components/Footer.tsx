function Footer(props: any) {
  return <footer className="bg-dark-1 pt-16">
    <div className="flex flex-row max-w-6xl place-items-center justify-between mx-auto px-6 pb-20">
      <div className="flex flex-col text-small text-placeholder">
        <p className="font-bold">AppImagePool</p>
        <p className="text-sm md:text-base">A simple AppImageHub client</p>
      </div>
      <a href="https://github.com/prateekmedia/appimagepool">
        <svg width="24px" height="24px" viewBox="0 0 24 24">
          ...
          <g id="github" filter="url(#filter_1)">
            <path d="M0 0L24 0L24 24L0 24L0 0Z" id="Background" fill="none" fillRule="evenodd" stroke="none" />
    ...
    <div className="bg-dark-2 flex flex-col text-center text-placeholder py-16 px-6">
